  ...
  RowLayout {
	...
	Text {
	  ...
	  Timer {
	    ...
	    repeat: true
	    onTriggered: {
	      // Check wifi status and update property 
      ...
      PopupWindow {
		...
		implicitHeight: 20
		radius: 10
		color: wifiText.isWifiOn ? "#9ccfd8" : "#393552" 
		...
		Rectangle {
		  ...
		  color: "#e0def4"
		  anchors.verticalCenter: parent.verticalCenter
		  x: wifiText.isWifiOn ? parent.width - width - 2 : 2 
		  Behavior on x { NumberAnimation { duration: 150; easing.type: Easing.OutQuad } } 
            ...
            RowLayout {
              ...
              Rectangle {
                ...
                implicitHeight: 20
                radius: 10
                color: BluezQt.Manager.bluetoothOperational ? "#c4a7e7" : "#393552"
                ...
                Rectangle {
                  ...
                  color: "#e0def4"
                  anchors.verticalCenter: parent.verticalCenter
                  x: BluezQt.Manager.bluetoothOperational ? parent.width - width - 2 : 2
                  Behavior on x { NumberAnimation { duration: 150; easing.type: Easing.OutQuad } }
                }
              }
            }
	...
	command: ["sh", "-c", "nmcli radio wifi $(nmcli radio wifi | grep -q 'enabled' && echo 'off' || echo 'on')"]
      ...
      // Background process for safe Bluetooth toggling
      Process {
        id: btToggleProc
